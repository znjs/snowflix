...
import { PlaylistVideoCardType } from "types/component-types";
import { removeVideoFromPlaylist } from "../../utils";

const PlaylistVideoCard: PlaylistVideoCardType = ({ video, playlistId, setFetchVideo }) => {
  const navigate = useNavigate();

  // *DATE FORMATTING
  let now: any = video.date;
  now = now.split("-");
      ...
      <div className="p-rel">
        ...
        <i
          ...
          onClick={() => {
            ...
            setFetchVideo((prev: Boolean) => !prev);
          }}></i>
      </div>
